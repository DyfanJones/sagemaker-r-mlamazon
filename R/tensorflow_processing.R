...
# https://github.com/aws/sagemaker-python-sdk/blob/master/src/sagemaker/tensorflow/processing.py
...
TensorFlowProcessor = R6Class("TensorFlowProcessor",
  ...
  public = list(
    ...
    #' @description This processor executes a Python script in a TensorFlow execution environment.
