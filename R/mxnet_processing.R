...
# https://github.com/aws/sagemaker-python-sdk/blob/master/src/sagemaker/mxnet/processing.py
...
MXNetProcessor = R6Class("MXNetProcessor",
  ...
  public = list(
    ...
    #' @description This processor executes a Python script in a managed MXNet execution environment.
    ...
    initialize = function(framework_version,  # New arg
                          role,
                          instance_count,
                          instance_type,
